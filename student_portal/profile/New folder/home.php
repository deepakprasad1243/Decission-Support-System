 ...
 <div style="width:80%;margin:auto;">
   ...
   <div class="row" style="margin:50px 0px 20px 0px">
    <div class="col-sm-3 col-md-3 col-lg-3 col-xs-12">
        <div style="background-color:#e5e5e5 ;border: 4px solid #000;box-shadow: 0 2px 4px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
   ...
   <table align="center" class="table-borderless">
      ...
      <a href="#" align="center" ><h4 align="right" style="padding-right:2%;padding-bottom:1%;">Edit
        <span class="glyphicon glyphicon-pencil"></span></h4>
      </a>
              </div>
              <div id="menu1" class="tab-pane fade" style="height:50%;">
                    <table align="center" class="table-borderless">
          ...
          <a href="#" align="center" ><h4 align="right" style="padding-right:2%;padding-bottom:1%;">Edit
            ...
            <div id="menu2" class="tab-pane fade">
              <div class="row">
                     <div class="col-xs-12 col-md-4" style="margin-left:2%;margin-top:1.5% ; margin-bottom:0.1%;margin-right:0.0%;"><a href="#popup1">
                         <div class="hvrbox">
     ...
     <i class="fa fa-search fa-lg" style="height:30px; width:30px;"></i>  </div></a>
                         ...
                         <h4 style="margin:.5%;"> Thoughtworks</h4>
             			<br><br>

        </div>

        <div class="col-xs-12 col-md-4"   style=" margin-top:1.5%; margin-bottom:0.1%; ;"><a href="#popup1">
            <div class="hvrbox">
          <img src="img1.jpeg" alt="" class="reveal img-responsive reveal-content image-center" > </a>
     <div class="hvrbox-layer_top">
   <div class="hvrbox-text"><a href="#popup1" class="icon" title="Preview">
...
<div class="col-xs-12 col-md-4"   style=" margin-left:2%;margin-top:.1%;padding-right:0.5%;"><a href="#popup1">
    <div class="hvrbox">
  <img src="img1.jpeg" alt="" class="reveal img-responsive reveal-content image-center" > </a>
<div class="hvrbox-layer_top">
<div class="hvrbox-text"><a href="#popup1" class="icon" title="Preview">
